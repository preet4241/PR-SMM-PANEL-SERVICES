...
if ( !function_exists( 'wp_editor' ) ) :
    ...
    ?>
    <div class="editor" <?php echo esc_attr( $custom_attributes) ?>
        <?php if ( isset( $data ) ) echo esc_attr( smms_plugin_fw_html_data_to_string( $data )) ?>><?php wp_editor( $value, $id, $editor_args ); ?></div>
