...
smms_plugin_fw_enqueue_enhanced_select();

$default_field = array(
    'id'       => '',
    'name'     => '',
    'class'    => 'smms-term-search',
    'no_value' => false,
    'multiple' => false,
    'data'     => array(),
    'style'    => 'width:400px',
...
$default_data = array(
    ...
    'placeholder' => __( 'Search Categories', 'smm-api' ),
    'allow_clear' => false,
    'taxonomy'    => 'category',
    'term_field'  => 'id'
);
...
?>
<div class="smms-plugin-fw-select2-wrapper">
    <?php
    if ( function_exists( 'smm_add_select2_fields' ) ) {
        smm_add_select2_fields( array(
                                    'id'                => $id,
                                    'name'              => $name,
                                    'class'             => $class,
