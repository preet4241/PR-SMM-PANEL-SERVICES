    ...
    class SMM_Icons {
        ...
        public function get_icons( $filter_icons = '' ) {
            ...
            if ( !empty( $filter_icons ) ) {
                $icons = apply_filters( 'smms_plugin_fw_icons_field_icons_' . sanitize_key( $filter_icons ), $icons );
            }
        ...
        private function _get_font_awesome_array() {
            $font_awesome_list    = get_option( 'smm_font_awesome_list', array() );
            ...
            if ( !empty( $font_awesome_list[ $font_awesome_version ] ) ) {
                ...
                update_option( 'smm_font_awesome_list', $font_awesome_list );
            }
        ...
        private function _get_dashicons_array() {
            $dashicons_list = get_option( 'smm_dashicons_list', array() );
        ...
        public function enqueue_scripts() {
            wp_register_style(
								'font-awesome',
								plugins_url( 'smm-api/assets/css/font-awesome.css', __FILE__ ),
								array(), // dependencies
								'4.6.3', // version
								'screen' // media
								);
...
if( ! function_exists( 'SMM_Icons' ) ){
	function SMM_Icons() {
		return SMM_Icons::get_instance();
	}
}
