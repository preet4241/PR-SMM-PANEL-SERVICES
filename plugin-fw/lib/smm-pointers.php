    ...
    class SMM_Pointers {
        ...
        public function __construct() {
            ...
            $this->_default_pointer['plugins'] = array(
                'screen_id'  => 'plugins',
                'options'    => array(
                    'content'  => sprintf( '<h3> Plugins Activated </h3> <p> From now on, you can find all plugin options in SMMS Plugins menu.
                                     Plugin customization settings will be available as a new entry in SMMS Plugins menu. </p> <p> Discover all our plugins available on:, <a href="http://softnwords.com/product-category/plugins/" target="_blank">softnwords.com</a> and
                                  <a href="https://profiles.wordpress.org/softnwords/" target="_blank">Wordpress.org</a></p>',
            ...
            $this->_default_pointer['update'] = array(
                'screen_id'  => 'update',
                'options'    => array(
                    'content'  => sprintf( '<h3>Plugins Upgraded  </h3> <p> From now on, you can find the option panel of SMMS plugins in SMMS Plugins menu.
                                    ...
                                    will be moved from previous location to SMMS Plugins tab. </p> <p> Discover all our plugins available on: <a href="http://softnwords.com/product-category/plugins/" target="_blank">softnwords.com</a> and
                                  <a href="https://profiles.wordpress.org/softnwords/" target="_blank">Wordpress.org</a></p>',
