...
if ( ! class_exists( 'SMM_Plugin_Common' ) ) :
...
class SMM_Plugin_Common {
    ...
    public function init() {
        self::$_config['header_backgrounds'] = apply_filters( 'smm_header_backgrounds', self::$_config['header_backgrounds'] );
        self::$_config['body_backgrounds']   = apply_filters( 'smm_body_backgrounds', self::$_config['body_backgrounds'] );
    }
    ...
    public static function get_icon_list() {
        ...
        return apply_filters( 'smm_icon_list', $standard_icon_list );
    }
    ...
    public static function get_icon( $icon ) {
        ...
        if ( $icon != '' ) {
            ...
            if( $icon_code ){
                $icon_code =  ( strpos( (string)$icon_code, '\\' ) === 0 ) ? '&#x' . substr( $icon_code, 1 ) . ';' : $icon_code;
            }
